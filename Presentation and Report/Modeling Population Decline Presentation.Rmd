...
pop.decline <- function(df, ntimes){
  ...
  scale_colour_manual(name="legend", values=c("orange", "green", "purple", "yellow"))   + labs(x = "Year", y = "Population")
...
```{r, echo=FALSE, fig.height=3.8, fig.width=4}
...
```{r, echo=FALSE, message = FALSE, warning=FALSE, fig.height=3.8, fig.width=4}
...
- Attempted to iteratively predict new values until population is extinct, R said "nah"
